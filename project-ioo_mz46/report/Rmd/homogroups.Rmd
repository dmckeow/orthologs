...
### Inputs needed
project-test_br/results/orthofinder_results/orthofinder_mcl/Orthogroups.tsv
  * made by custom nf module - which homogroups contain what sequences
project-test_br/results/prefilter/initial/defline_info/*.csv
  * made by custom nf module - hmmsearch assignment for each sequence
project-test_br/results/orthofinder_results/orthofinder_mcl/Orthogroups.GeneCount.tsv
  * just Orthogroups.tsv just totals instead of deflines
