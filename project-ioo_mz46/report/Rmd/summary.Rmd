...
og_tax_count <- data.frame("gene_family" = generax_res_per_fam$events_per_og$gene_family,
             ...
             "deuterostomia_number_species" = NA,
             "protostomia_number_species" = NA,
...
og_tax_copynum <- data.frame("gene_family" = generax_res_per_fam$events_per_og$gene_family,
             ...
             "deuterostomia_copy_number" = NA,
             "protostomia_copy_number" = NA,
...
event_rates_3d_plt <-
  plot_ly(x = rates_per_og$duplication, y = rates_per_og$loss,
          ...
          text = ~paste0(
                          ...
                          '# Deuterostomia: ', og_tax_summary$deuterostomia_number_species, '<br>',
                          '# Protostomia: ', og_tax_summary$protostomia_number_species, '<br>',
