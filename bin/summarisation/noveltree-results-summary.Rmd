...
tsar_cols <- 
  c(Ctenophora = '#8A99AD', Porifera = '#FFB984')
```
...
per_spp_of_stats <-
  get_per_spp_ofinder_stats(tree_fpath = paste0(result_directory, 'speciesrax/species_trees/inferred_species_tree.newick'),
                        ...
                        samplesheet_fpath = paste0(result_directory, '../../ioo-samplesheet1.csv'),
...
samplesheet <- read.table(paste0(result_directory, '../../ioo-samplesheet1.csv'),
                          sep = ",", header = T)
